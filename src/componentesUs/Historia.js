...
export const Historia = () => {
  return (
    <>
      <div className="bg-white contacto text-center font-baloo pt-2 rounded w-full h-full ">
        ...
        <p className="text-justify overflow-hidden font-bold font-baloo mt-2  mx-16">
