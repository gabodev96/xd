    ...
    <div className="bg-red-500 h-full flex w-screen rounded-lg  justify-center m-auto">
      <footer class="bg-white dark:bg-gray-900 rounded-md w-full">
        <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
          ...
          <div>
            <h2 class="mb-6 text-sm font-semibold text-gray-500 uppercase font-baloo dark:text-gray-400">
              Centro de Ayuda
            </h2>
            <ul class="text-gray-500 dark:text-gray-400">
              <li class="mb-4">
        ...
        <div class="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
          <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center font-baloo">
